        ...
        <Container className="relative h-[800px] md:h-[600px] sm:h-[400px]">
          <Row className="items-center h-full md:pb-40 sm:pb-0">
            <Col lg={{ span: 6, offset: 6 }} sm={{ span: 7, offset: 5 }}>
              <h2 className="font-serif text-white -tracking-[1px] mb-[40px] xs:mb-[25px] font-medium xs:text-center">I'm <span className="text-decoration-line-bottom-thick">antonio garcia tagaruma</span></h2>
