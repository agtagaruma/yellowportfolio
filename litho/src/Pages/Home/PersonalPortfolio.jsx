...
import { SocialIconsData02 } from '../../Components/SocialIcon/SocialIconsData'
  ...
  return (
    <div style={props.style}>
          ...
          <Col lg={2} sm={6} className="col-auto ps-lg-0 me-auto md:!px-0">
            <Link aria-label="link for" className="flex items-center" to="/">
              <Navbar.Brand className="inline-block p-0 m-0">
                <img className="default-logo" width="111" height="111" loading="lazy" src='/assets/img/webp/symbol-black.webp' data-rjs='/assets/img/webp/symbol-black@2x.webp' alt='logo' />
                  ...
                  <Row className="h-[100vh] p-28 xs:p-12 mx-0 items-center justify-center bg-black">
                    ...
                    <Col className="col-12 text-left none md:block sm:hidden px-0">
                      <div className="font-serif mt-[50px]">
                        ...
                        <h2 className="heading-6 mb-0"><a aria-label="gmail" href="mailto:agtagaruma@live.com" className="text-[#ffeb04] border-b border-[#ffeb04] hover:text-white hover:border-white">agtagaruma@live.com</a></h2>
                      </div>
                    </Col>
                  </Row>
                </Col>
      ...
      <div className="md:flex md:items-center overflow-hidden relative h-[100vh] landscape:md:h-[600px]">
        <Parallax className="lg-no-parallax bg-cover absolute top-[0px] left-0 md:-top-[0px] w-full h-[100vh] sm:h-[100vh] md:h-[650px] !bg-[50%_0] lg:bg-[right_-230px_center] md:bg-right sm:top-0 sm:bg-[right_-350px_center] landscape:bg-right" translateY={[-20, 20]} style={{ backgroundImage: `url(https://i.ibb.co/dm47H74/image.png)` }}></Parallax>
        <Container>
          <Row className="full-screen md:h-[520px] sm:h-[100vh] mb-[150px]">
            <Col xl={9} md={5} className="relative flex flex-col justify-center">
              <h2 className="font-serif font-light -tracking-[2px] text-darkgray uppercase mt-[220px]">Hello,  i am</h2>
              <div className="font-serif cd-headline push">
                <h3 className="heading-5 mb-0 text-darkgray font-serif">
                  <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[90px] leading-[95px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[90px] md:text-[70px] md:leading-[65px] sm:text-[45px] sm:leading-[43px]" animation="push" data={["Antonio", "Insightful", "Tech-savvy", "Innovative", "Creative", "Captivating"]} />
                </h3>
                <h4 className="heading-5 mb-0 text-darkgray font-serif">
                  <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[75px] leading-[95px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[90px] md:text-[70px] md:leading-[65px] sm:text-[45px] sm:leading-[43px]" animation="push" data={["Tagaruma", "Teacher", "Web-dev" , "Marketing Specialist", "Graphic Designer", "Photographer"]} />
                </h4>
              </div>
        ...
        <Container>
          <Row className=" align-center">
            <m.div className="col-lg-5 text-darkgray md:mb-[30px] text-left" {...fadeIn}>
              <h2 className="heading-6 font-serif leading-[40px] w-[90%] mb-0 lg:w-full sm:leading-[26px] xs:text-center">A versatile teacher, graphic designer, and marketing specialist, passionate about minimalist design, clean typography, and expertly crafted code, located in &nbsp;
                <span className="font-bold text-decoration-line-bottom-medium leading-[40px] whitespace-nowrap sm:leading-[26px]">Thailand</span></h2>
            </m.div>
            <Col xl={{ span: 6, offset: 1 }} lg={7} md={9} className="flex items-center xs:flex-col">
              <m.div className="w-[60%] md:w-[55%] xs:w-full xs:mb-[15px]" {...{ ...fadeInLeft, transition: { delay: 0.4, duration: 0.4 } }}>
                <span className="font-serif text-[11rem] leading-[11rem] text-darkgray font-semibold -tracking-[7px] block xs:text-center md:text-[9rem]"><span className="text-[#ffeb04] font-light mr-[35px]">|</span>15<span className="text-[#ffeb04] font-light ml-[35px]">|</span></span>
              </m.div>
              <m.div className="text- w-[40%] pl-[25px] xs:w-full md:pl-0"  {...{ ...fadeInLeft, transition: { delay: 0.6, duration: 0.6 } }}>
                <h3 className="heading-5 font-serif font-medium text-darkgray mb-0 -tracking-[1px] xs:text-center">Years of extensive expertise</h3>
              </m.div>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <m.div className="row" {...{ ...fadeIn, transition: { delay: 0.4 } }}>
            <Col className="col-lg-5 md:mb-20 sm:mb-16">
              <h2 className="heading-6 font-serif text-darkgray mb-0 leading-[40px] sm:leading-[26px]">We are a <span className="font-semibold">reputable provider of onshore & offshore web development services, specializing in teaching, graphic design, marketing, web development, and photography.</span> Our global clientele benefits from cost-effective solutions tailored to their unique needs. With a commitment to innovation and excellence, we deliver personalized services, resulting in exceptional websites, compelling marketing campaigns, and professional photography. Whether you are an individual or a business, we aim to surpass expectations and meet your specific requirements.</h2>
            </Col>
